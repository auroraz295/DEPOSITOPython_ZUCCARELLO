...
#TUPLE, tipo tuple, definita da () ma non si usano, miste e immutabili
punto = 3,4
x, y = punto
print(x, y)

#SET, tipo set, definita da {}, omogenei, modificabili e non ordinati
set1 = set([1, 2, 3, 4, 5])
set2 = {4, 5, 6, 7, 8}
set3 = {1, 2, 3, 3, 4, 4, 5}
...
#METODI MATEMATICI DEGLI INSIEMI
